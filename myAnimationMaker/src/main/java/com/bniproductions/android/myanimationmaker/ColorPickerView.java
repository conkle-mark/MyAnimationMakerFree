...
public class ColorPickerView extends View {
    ...
    private static final String DTAG = "ColorPickerView";
    ...
    private void init() {
        ...
        PALETTE_CIRCLE_TRACKER_RADIUS *= mDensity; //PALETTE_CIRCLE_TRACKER_RADIUS = PALETTE_CIRCLE_TRACKER_RADIUS * mDensity
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                Log.d(DTAG, "ACTION_DOWN mStartTouchPoint: " + mStartTouchPoint);
