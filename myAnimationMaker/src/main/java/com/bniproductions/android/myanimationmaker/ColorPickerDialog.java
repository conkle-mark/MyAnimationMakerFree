...
public class ColorPickerDialog extends Dialog implements ColorPickerView.OnColorChangedListener, View.OnClickListener {
        ...
        private String DTAG = "ColorPickerDialog";
        ...
        private void setUp(int color) {
                ...
                // pressColor = (TextView) layout.findViewById(R.id.press_color_to_apply);
                /*
                Log.d(DTAG, "color_picker_view:height: "+mColorPicker.getHeight());
                Log.d(DTAG, "ColorPickerPanelView:Height "+mOldColor.getHeight());
                Log.d(DTAG, "ColorPickerPanelView:Width "+mOldColor.getWidth());
                Log.d(DTAG, "TextView:Width "+pressColor.getWidth());
                */
                
                mHexVal = (EditText) layout.findViewById(R.id.hex_val);
                mHexVal.setInputType(InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
                mHexDefaultTextColor = mHexVal.getTextColors();
                // Log.d(DTAG, "in setUp "+mHexDefaultTextColor);
                ...
                ((LinearLayout) mNewColor.getParent()).setPadding(
                ...
                doneButton.setOnTouchListener(new View.OnTouchListener() {
                        ...
                        public boolean onTouch(View v, MotionEvent event) {
                                ...
                                Log.d(TAG, "onTouch done: " + mListener.toString());
                                dismiss();
                                return false;
                        }
                });
        ...
        /*
         * (non-Javadoc) added to DialogFragment
         * @see com.bniproductions.android.myscreenplay2.ColorPickerView.OnColorChangedListener#onColorChanged(int)
         */
        @Override
        public void onColorChanged(int color) {
        ...
        public void onClick(View v) {
                if (v.getId() == R.id.new_color_panel) {
                        ...
                        Log.d(TAG, "onClick mListener: "+mListener.toString());
                }
                //dismiss();
        }
